...
public sealed class CustomerDeliveryAddressAdminService : ICustomerDeliveryAddressAdminPort
{
    private readonly WebShopABMATICDbContext _db;

    public CustomerDeliveryAddressAdminService(WebShopABMATICDbContext db) => _db = db;
