...
public sealed class CustomerProductDiscountAdminService : ICustomerProductDiscountAdminPort
{
    private readonly WebShopABMATICDbContext _db;

    public CustomerProductDiscountAdminService(WebShopABMATICDbContext db) => _db = db;
