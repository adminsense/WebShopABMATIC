...
public sealed class WebshopProductStructureAdminService : IWebshopProductStructureAdminPort
{
    private readonly WebShopABMATICDbContext _db;

    public WebshopProductStructureAdminService(WebShopABMATICDbContext db) => _db = db;
